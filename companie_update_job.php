...
//$result= mysqli_query($db,$sql);
    ...
    if ($nr == 1) {
        ...
        echo "<form method=\"post\" action=\"companie_update_job.php?id=" . $id . "\">";
        echo "<div class=\"row\">";
...
//        echo "Id: <input type=\"hidden\" name=\"job_id\" value=". $myrow["id"]. ">";
    ...
    if (isset($_POST["btnSubmit"])) {
        ...
        $sql_upd = "UPDATE add_job SET nume_firma='$nume_firma',titlu='$titlu',nr_joburi_disponibile='$nr_joburi_disponibile',carnet_de_conducere='$carnet_de_conducere',tip_job='$tip_job',nivel_cariera='$nivel_cariera',limbi_straine='$limbi_straine', locatie ='$locatie',descriere='$descriere' where id=$id;";
