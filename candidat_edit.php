...
//$result= mysqli_query($db,$sql);
        ...
        if ($nr == 1) {
            ...
            echo "<button onclick=\"window.location='setari_candidat.php'\" type=\"submit\" class=\"success button\" name=\"btnSubmit\">Modifica</button>";
            echo "</div>";
            echo "</div>";
        ...
        if (isset($_POST["btnSubmit"])) {
            ...
            $sql_upd = "UPDATE candidati SET nume='$nume', prenume ='$prenume',oras='$oras',email='$email',varsta='$varsta',telefon='$telefon',parola='$parola' where id_client='$id_client';";
...
<a href="setari_candidat.php" class="button">Inapoi</a>
