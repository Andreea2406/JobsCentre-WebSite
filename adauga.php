...
$mode="";
    ...
    if ($mode == "adaugare") {
        ...
        if ((empty($_POST["titlu"]))&&(empty($_POST["locatie"]))&&(empty($_POST["descriere"]))&&(empty($_POST["tip_job"]))) {
...
$sql="INSERT INTO joburi(titlu,locatie,descriere,tip_job) VALUES ('$titlu','$locatie','$descriere','$tip_job')";
            echo $sql;
